...
| Audio input (microphone) | **Not started** | [doc](docs/hardware/audio-input-mic.md) | no input path exists: the only ALSA capture subdevice is the HDMI-Rx codec (bit-exact silence, capture confirmed dead 2026-09-23) and the HAT's amp is output-only; USB mic via OTG is the declared path for the voice agent's push-to-talk (G0 in [plans/current/2026-09-23-22-57-17_voice-agent-gates.md](plans/current/2026-09-23-22-57-17_voice-agent-gates.md) — hardware proof pending) |
